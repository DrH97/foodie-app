...
<header>
        <div class="container">
                ...
                <div class="right-area">
                        ...
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link sdropdown-toggle" href="/" role="button" adata-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    {{ Auth::user()->name }} 
                ...
                <ul class="main-menu font-mountainsre" id="main-menu">
                        ...
                        <li><a href="/home">WHAT'S NEW</a></li>
                        <li><a href="/home">OUR KITCHEN</a></li>
                        <li><a href="/home">MENU</a></li>
                        <li><a href="/home">ORDER ONLINE</a></li>
                        <li><a href="/home">LOCATION & CONTACT</a></li>
                </ul>
        ...
        <div class="container h-100">
                <div class="dplay-tbl">
                        <div class="dplay-tbl-cell center-text color-white">
                                ...
                                <h1 class="mt-30 mb-15">Foodie App</h1>
